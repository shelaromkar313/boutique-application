            ...
            <div class="space-y-6">
                <div class="bg-[var(--color-ebony)] text-white p-5 sm:p-8 rounded-2xl sm:rounded-3xl shadow-[var(--shadow-floating)] space-y-4 sm:space-y-6">
                    ...
                    <div class="space-y-4 text-xs font-sans text-white/80">
                        <div class="flex items-start gap-3">
                            ...
                            <span>
                                ...
                                Opposite Mission School, Tripunithura
                            </span>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span>Phone: +91 98950 37106</span>
                        </div>
                    ...
                    <div class="pt-4 border-t border-white/10">
                        <a href="https://wa.me/919895037106" target="_blank" rel="noreferrer" class="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white font-sans text-xs font-bold uppercase tracking-wider py-3.5 rounded-full flex items-center justify-center gap-2 transition-colors shadow-md">
                ...
                <form action="#" method="POST" class="bg-white p-5 sm:p-10 rounded-2xl sm:rounded-3xl border border-[var(--color-bisque)]/60 shadow-sm space-y-5 sm:space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="tel" required placeholder="+91 98950 37106" class="w-full bg-[var(--color-offwhite)] border border-[var(--color-bisque)] rounded-xl px-4 py-3 text-xs font-sans focus:outline-none focus:border-[var(--color-rose-antique)]" />
                        </div>
                    </div>
