        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-[var(--color-bisque)]">
            ...
            <div class="flex items-center gap-3">
                ...
                <form action="{{ route('logout') }}" method="POST" class="inline m-0">
                    @csrf
                    <button type="submit" class="bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-800 text-xs font-sans font-bold uppercase tracking-wider px-4 py-2.5 rounded-full flex items-center gap-1.5 transition-colors" title="Sign Out">
