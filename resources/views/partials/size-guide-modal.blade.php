        ...
        <div class="overflow-x-auto">
            <table class="w-full text-xs font-sans text-left border-collapse">
                ...
                <tbody class="divide-y divide-[var(--color-bisque)]/40 text-[var(--color-ebony)]/80">
                    <tr><td class="p-2.5 font-bold text-[var(--color-ebony)]">XS (34)</td><td class="p-2.5" x-text="unit === 'in' ? '34\"' : '86 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '28\"' : '71 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '36\"' : '91 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '44\"' : '112 cm'"></td></tr>
                    <tr><td class="p-2.5 font-bold text-[var(--color-ebony)]">S (36)</td><td class="p-2.5" x-text="unit === 'in' ? '36\"' : '91 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '30\"' : '76 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '38\"' : '96 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '44\"' : '112 cm'"></td></tr>
                    <tr><td class="p-2.5 font-bold text-[var(--color-ebony)]">M (38)</td><td class="p-2.5" x-text="unit === 'in' ? '38\"' : '96 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '32\"' : '81 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '40\"' : '101 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '45\"' : '114 cm'"></td></tr>
                    <tr><td class="p-2.5 font-bold text-[var(--color-ebony)]">L (40)</td><td class="p-2.5" x-text="unit === 'in' ? '40\"' : '101 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '34\"' : '86 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '42\"' : '106 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '45\"' : '114 cm'"></td></tr>
                    <tr><td class="p-2.5 font-bold text-[var(--color-ebony)]">XL (42)</td><td class="p-2.5" x-text="unit === 'in' ? '42\"' : '106 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '36\"' : '91 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '44\"' : '112 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '46\"' : '117 cm'"></td></tr>
                    <tr><td class="p-2.5 font-bold text-[var(--color-ebony)]">XXL (44)</td><td class="p-2.5" x-text="unit === 'in' ? '44\"' : '112 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '38\"' : '96 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '46\"' : '117 cm'"></td><td class="p-2.5" x-text="unit === 'in' ? '46\"' : '117 cm'"></td></tr>
